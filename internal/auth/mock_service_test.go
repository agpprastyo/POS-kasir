...
//
//	mockgen -source=internal/auth/service.go -package=auth -destination=internal/auth/mock_service_test.go
//
...
func (m *MockIAuthService) Login(ctx context.Context, req LoginRequest) (*LoginResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) Profile(ctx context.Context, userID uuid.UUID) (*ProfileResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) Register(ctx context.Context, req RegisterRequest) (*ProfileResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) UpdatePassword(ctx context.Context, userID uuid.UUID, req UpdatePasswordRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) UploadAvatar(ctx context.Context, userID uuid.UUID, data []byte) (*ProfileResponse, error) {
	m.ctrl.T.Helper()
