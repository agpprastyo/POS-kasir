...
CREATE TABLE public.cash_transactions (
  ...
  CONSTRAINT cash_transactions_shift_id_fkey FOREIGN KEY (shift_id) REFERENCES public.shifts(id),
  CONSTRAINT cash_transactions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);
...
CREATE TABLE public.order_items (
  ...
  cost_price_at_sale numeric NOT NULL DEFAULT 0 CHECK (cost_price_at_sale >= 0::numeric),
