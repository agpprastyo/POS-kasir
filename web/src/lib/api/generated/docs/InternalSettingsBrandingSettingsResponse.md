# InternalSettingsBrandingSettingsResponse
...
```typescript
import { InternalSettingsBrandingSettingsResponse } from 'restClient';

const instance: InternalSettingsBrandingSettingsResponse = {
    app_logo,
    app_name,
    footer_text,
    theme_color,
