# POSKasirInternalDtoProductListResponse
...
```typescript
import { POSKasirInternalDtoProductListResponse } from 'restClient';

const instance: POSKasirInternalDtoProductListResponse = {
    category_id,
    category_name,
    deleted_at,
    id,
